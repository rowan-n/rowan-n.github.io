...
Not only is the average age of Native Americans who get stopped in North Dakota lower than that of the total average, but there is a notable increase in Native Americans minors who get stopped. 
...
Are there differences over time? Are there differences across datasets? Is there anything interesting about pedestrian stops versus vehicular stops? (I’m not sure how many of the datasets have much information on pedestrian stops). Your analysis should have the following elements:

queries of at least three of the SQL tables at least 6 uses of SQL keywords other than SELECT, FROM, and LIMIT. at least 2 illustrative, well-labeled plots or tables a description of what insights can be gained from your plots and tables
