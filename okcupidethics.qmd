---
title: "OkCupid Data Ethics"
execute:
  echo: false
description: A brief discussion of the responsibilities of data scientists. 
...
While the ethical violations here did not seem to be committed in the interest of harming anyone, neglect and carelessness by the creators of the dataset was still very damaging. Either the creators knew that releasing personal information about someone's dating life could be damaging, thus causing harm knowingly and intentionally, or they did not consider that the dataset might be used for harm, which is neglectful. The dataset is ultimately harmful to those who would suffer if their religion, sexuality, drug history, etc. were made public and easily tied back to them. Neglecting to consider the repercussions that releasing sensitive information might have on the lives of religious minorities, people with or recovering from substance use disorders, and queer people is frankly naïve. It is important to consider not only if what *we* intend to do with our data will cause harm, but also to consider what someone who *wants* to cause harm might do with our data.
