...
#rename all of the German variable names. I couldn't get the Proband:innen one to rename, I think because of the colon, but that's participant ID 
...
TesLaS_DataSet <- TesLaS_DataSet |> 
  rename(
    ...
    condition = Bedingung,
    variant = Variante,
    correct_images_total = Summe_Korrekt_Abbildungen,
    correct_statements_total = Summe_Korrekt_Aussagen,
    correct_total = Summe_Gesamt,
    correct_testing = Summe_Korrekt_Testing,
    correct_restudy = Summe_Korrekt_Restudy,
