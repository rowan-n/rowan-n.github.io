...
![Schematic overview of the three between-subjects conditions regarding language-switching (Wußing et al., 2023).](study_flowchart.jpg){fig-alt="A chart depicting which language each of the three condition groups were speaking during which portion of the study."}
...
#| message: false
#| warning: false
#| fig-alt: "A 6 x 16 tibble showing the first 6 rows of the data from the study."
...
#| message: false
#| warning: false
#| fig-alt: "A 3 x 6 tibble showing the mean correct answers on each test per condition group."
...
#| message: false
#| warning: false
#| fig-alt: "A histogram depicting the null permutation results with a red vertical line to mark the observed data from the study."
...
#| message: false
#| warning: false
#| fig-alt: "The results of a two-sided p value test. p = 0.002"
...
#| message: false
#| warning: false
#| fig-alt: "The results of a two-sided p value test. p = 0.615"
...
#| message: false
#| warning: false
#| fig-alt: "The results of a two-sided p value test. p = 0.022"
